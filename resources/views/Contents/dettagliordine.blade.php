<h5 class="mtext-108 cl2 p-b-25">
    Codice Ordine: {{$ordini[0]->IDorders}} Data Acquisto: {{$ordini[0]->created_at}}
</h5>
...
<table class="table-profile p-t-30 m-b-30">
    <tr class="table_head">
        ...
        @foreach($ordini as $ordine)
            <tr class="table_row">
                <td class="column-2 p-l-50 p-t-25"><img src="{{asset('storage/'.$ordine->img_dir)}}" class="w-50 h-75" alt="IMAGE"></td>
